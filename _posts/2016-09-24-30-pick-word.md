...
## Exercise {{ page.number }} (and [Solution]({{ site.baseurl }}{% post_url 2016-10-15-30-pick-word-solutions %}))
...
1. [Exercise 22: read from a file]({{ site.baseurl }}{% post_url 2014-12-06-22-read-from-file %}) {% include chili.md chilis=1 %}
2. [Exercise 9: generating a random number]({{ site.baseurl }}{% post_url 2014-04-02-09-guessing-game-one %}) {% include chili.md chilis=3 %}
3. [Exercise 3: accessing an element of a list]({{ site.baseurl }}{% post_url 2014-02-15-03-list-less-than-ten %}) {% include chili.md chilis=2 %}

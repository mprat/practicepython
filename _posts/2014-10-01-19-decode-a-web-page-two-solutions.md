...
A few people submitted solutions to this exercise (one example is given at the bottom of the page), and many of them used things that I haven't yet talked about in the exercises. 
...
BELOW THIS WAS TAKEN FROM THE PREVIOUS SOLUTION

, involving many complex pieces of code and two new Python modules. When appropaching problems like this one, it helps to develop a plan for the program before executing it. 
...
<figure class="twocol-figure">
  <img src="{{ site.baseurl }}/assets/img/inspect_element.png">

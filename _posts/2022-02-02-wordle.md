...
{% highlight python %}
def compare(correct: str, guess: str):
    """Compare the guess with the correct word and display."""
{% endhighlight %}

What we'll do is take in the `correct` game word as a string, and the (parsed and validated) `guess` word as a string. This function will do all the character comparison, and print the output to the command-line.

...
There are no new topics this week, but you will need to use [Python's random module](https://docs.python.org/3.3/library/random.html), described in [this post](http://practicepython.blogspot.co.il/2014/04/exercise-9-randomness-guessing-game.html). 
